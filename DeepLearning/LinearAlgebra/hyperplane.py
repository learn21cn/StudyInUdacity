...
class HyperPlane(object):
    ...
    EITHER_DIM_OR_NORMAL_VEC_MUST_BE_PROVIDED_MSG = 'Check dimension and normal_vector'
...
# print('the pair of HyperPlanes are parallel?:{}'.format(p1.is_parallel_to(p2)))
# print('the pair of HyperPlanes are equal?:{}'.format(p1 == p2))